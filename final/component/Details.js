  ...
  return (
    ...
    <ScrollView style={styles.view}>
      ...
      <View>
        ...
        <StarRating/>
        <TouchableOpacity style={styles.subButton} onPress={getDirection}>
          <Text style={styles.buttonText}>{getDir}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.subButton} onPress={editpost}>
          <Text style={styles.buttonText}>{edit}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.subButton} onPress={sharepost}>
