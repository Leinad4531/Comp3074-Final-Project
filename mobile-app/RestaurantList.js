...
const RestaurantList = () => {
  const [restaurantData, setRestaurantData] = useState([
    { name: 'Restaurant 1', description: 'Authentic restaurant', address: '160 kendal avenue', phone: '413-234-0000', rating: 1, tags: 'tag1 tag2', comment: 'This restauarant was one of the best!' },
